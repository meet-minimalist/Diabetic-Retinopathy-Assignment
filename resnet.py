...
def resnet_baseline(image_height, image_width, num_classes=5):
    base_model_resnet = ResNet50(weights='imagenet', include_top=False, input_shape=(image_width, image_height, 3))
    ...
    last_layer = Flatten()(base_model_resnet.output)
    ...
    model_resnet = Model(inputs=base_model_resnet.input, outputs=last_layer)
